export const Footer = () => {
  return (
    <footer className="font-semibold flex items-center justify-between gap-4 relative z-10">
      <div className="flex items-center justify-between gap-4">
        <button className="p-[1px] audio relative rounded-full overflow-hidden transition-transform duration-500">
          ...
          <span className="animate-border bg-[linear-gradient(110deg,_theme(colors.black),45%,_theme(colors.neutral.950),55%,_theme(colors.black))] bg-[length:200%_100%] rounded-full backdrop-blur-md uppercase flex items-center justify-center w-10 h-10">
